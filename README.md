...
* Step 8. As user jenpo_client, execute Firefox and goto [https://check.torproject.org/],you shall see ¡¥congratulations¡K¡¦,which means that the tor client has successfully solved the bridge¡¦s puzzle and make its IP address appear to be like 178.63.97.34 (The VM¡¦s IP is 128.59.23.176).
